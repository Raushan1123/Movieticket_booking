...
<div class="container">
  ...
  <div class="ooo">
    ...
    <div class="row">
     ...
     <h1 id="hed1">X-Men: Dark phoenix</h1>
   <iframe class="center" width="860" height="415" src="https://www.youtube.com/embed/azvR__GRQic" frameborder="0" 
   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    This is the story of one of the X-Men`s most beloved characters, Jean Grey, as she evolves into the iconic DARK PHOENIX.
     During a life-threatening rescue mission in space, Jean is hit by a cosmic force that transforms her into one of the
      most powerful mutants of all. Wrestling with this increasingly unstable power as well as her own personal demons, 
      Jean spirals out of control, tearing the X-Men family apart and threatening to destroy the very fabric of our planet. 
      The film is the most intense and emotional X-Men movie ever made. It is the culmination of 20 years of X-Men movies, 
      as the family of mutants that we`ve come to know and love must face their most devastating enemy yet -- one of their own. 
      </p>

     <p>CAST: </p>
     <div class="casting">
     <img src="./image/image1/evan.jpg" title="Evan peters">
     <img src="./image/image1/james.jpg" title="James macvoy">
     <img src="./image/image1/olivia munn.jpg" title="Olivia munn">
     <img src="./image/image1/jean.jpg" title="Jean grey">
     </div>
    ...
    <table class="table table-hover">
        ...
        while(rs.next()){
        	...
        	<%
        	   ...
        	   String sql2="select title,duration from moviedatabase where title='Dark phoenix' AND id="+Mid;
...
<br/>
     ...
     <div class="col-md-4">
     <div class="col-6"><a href="kgf.jsp"><img src="./image/image1/KGF.jpg"></a></div>&nbsp;
