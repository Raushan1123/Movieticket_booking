...
<div class="container">
  ...
  <div class="ooo">
    ...
    <div class="row">
     ...
     <h1 id="hed1">Avengers Endgame</h1>
    <iframe class="center" width="860" height="415" src="https://www.youtube.com/embed/TcMBFSGVi1c" frameborder="0"
    ...
    The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers
     ranks compels the remaining Avengers to take one final stand in Marvel Studios` grand conclusion to twenty-two 
     films, "Avengers: Endgame." </p>
     <p>CAST: </p>
     <div class="casting">
     <img src="./image/image1/ironman.jpg" title="Robert downey junior">
     <img src="./image/image1/capn.jpg" title="Chris evans">
     <img src="./image/image1/thor.jpg" title="Chris hamesworth">
     <img src="./image/image1/blackwidow.jpg" title="Scarlett johanson">
     </div>
    ...
    <table class="table table-hover">
        ...
        while(rs.next()){
        	...
        	<%
        	   ...
        	   String sql2="select title,duration from moviedatabase where title='Avengers-Endgame' AND id="+Mid;
