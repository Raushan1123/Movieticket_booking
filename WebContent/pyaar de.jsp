...
<div class="container">
  ...
  <div class="ooo">
    ...
    <div class="row">
     ...
     <h1 id="hed1">De De Pyaar De</h1>
   <iframe class="center" width="860" height="415" src="https://www.youtube.com/embed/EJUD2PptXrk" frameborder="0" 
   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     ...
     <p>SYNOPSIS
      <br/>
      <br/>
    Luv Ranjan's De De Pyaar De is a contemporary rom-com with a quirky take on urban relationships. 
    The film starring Ajay Devgn, Tabu and Rakul Preet Singh is directed by the renowned Hindi film editor, Akiv Ali. 
      </p>

     <p>CAST: </p>
     <div class="casting">
     <img src="./image/image1/ajay.jpg" title="Ajay devgan">
     <img src="./image/image1/tabbu.jpg" title="Tabu">
     <img src="./image/image1/rakul.jpg" title="Rakul preet singh">
     <img src="./image/image1/javed.jpg" title="Javed jaffrey">
     </div>
    ...
    <table class="table table-hover">
        ...
        while(rs.next()){
        	...
        	<%
        	   ...
        	   String sql2="select title,duration from moviedatabase where title='De De Pyaar De' AND id="+Mid;
...
<br/>
     ...
     <div class="col-md-4">
     <div class="row">
     <div class="col-6"><a href="Avengers.jsp"><img src="./image/image1/Avengers 2.jpg"></a></div>&nbsp;
